  ...
  const changes = [
    {
      ...
      description:
        "Perubahan mendasar dalam perencanaan pengembangan sumber daya manusia",
    },
    {
  ...
  const processSteps = [
    {
      ...
      description:
        "Rapat pimpinan tertinggi mengidentifikasi kebutuhan pengembangan",
    },
    {
      step: "2",
      title: "Analisis Kebutuhan",
      description:
        "Berdasarkan isu strategis organisasi yang diputuskan manajemen",
    },
    {
      step: "3",
                ...
                >
                  ...
                  >
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      <strong>Kumham CorpU</strong> merupakan manajemen
                      strategis pengembangan SDM yang fokus pada program
                      strategis Kementerian, dengan mengelola individu pegawai
                      dalam ekosistem organisasi pembelajar, serta pengelolaan
                      pengetahuan untuk pencapaian karakter unggul di bidang
                      Hukum dan HAM.
                    </p>
                    ...
                    >
                      <p className="text-gray-700 italic">
                        Corporate University bukan lembaga atau institusi
                        pendidikan dan pelatihan yang menempel (embedded),
                        melainkan strategi manajemen agar terjadi pembelajaran
                        individu dan pembelajaran dalam organisasi, serta
                        pengelolaan pengetahuan individu dan pengetahuan
                  ...
                  <motion.div
                    ...
                    whileHover={{ x: 3 }}
                  >
                    <h3 className="text-xl font-semibold text-[#1c2c66] mb-3">
                      Ekosistem Organisasi Pembelajar
                    </h3>
                    <p className="text-gray-700 mb-4">
                      Pembentukan ekosistem organisasi pembelajar memberikan
                      kesempatan bagi seluruh komponen untuk belajar setiap saat
                      dan mengembangkan diri untuk memenuhi standarisasi potensi
                      atau talenta.
                    </p>
                    <motion.div
                  ...
                  <motion.div variants={itemVariants} className="mb-12">
                    <h2 className="text-2xl font-bold text-[#1c2c66] mb-6">
                      Paradigma Baru CorpU
                    </h2>
                    <p className="text-gray-700 mb-6">
                      Paradigma CorpU berdampak pada 3(tiga) perubahan yang
                      menonjol:
                    </p>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold text-[#1c2c66] mb-2">
                        ...
                        <ul className="text-gray-600 space-y-1 text-sm">
                          {[
                            ...
                            <motion.li
                              ...
                              whileHover={{ x: 3 }}
                            >
                              <span className="bg-[#1c2c66] text-white rounded-full w-4 h-4 flex items-center justify-center text-xs font-bold mr-2 mt-1">
                                -
                              </span>
                              <span>{item}</span>
                            </motion.li>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      {processSteps.map((step, index) => (
                        ...
                        >
                          ...
                          <h3 className="text-sm font-semibold text-[#1c2c66] mb-2">
                            {step.title}
                          </h3>
                  ...
                  >
                    <h3 className="text-xl font-semibold text-[#1c2c66] mb-3">
                      Tanggung Jawab CorpU
                    </h3>
                    <p className="text-gray-700 mb-4">
                      Corporate University bertanggungjawab untuk dapat
                      memastikan semua pegawai belajar dan mempelajari hal-hal
                      secara benar, dengan cara penyampaian pembelajaran yang
                      benar.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      {[
                        {
                          icon: <FiGlobe />,
                          text: "Memperoleh Sumber Pengetahuan",
                        },
                        {
                          icon: <FiBook />,
                          text: "Mendokumentasikan Pengetahuan",
                        },
                        {
                          icon: <FiShield />,
                          text: "Mendistribusikan & Menerapkan",
                        },
                      ].map((item, index) => (
                        <motion.div
                          key={index}
                        ...
                        >
                          <div className="flex items-center mb-2">
                            {item.icon}
                            <span className="font-semibold text-[#1c2c66] ml-2">
                              {item.text}
                            </span>
                          </div>
                        </motion.div>
