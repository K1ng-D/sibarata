...
import { FiCheckCircle, FiClipboard, FiUsers, FiBook, FiFileText, FiHelpCircle, FiHome, FiChevronRight, FiArrowRight } from 'react-icons/fi';
          ...
          >
            ...
            >
              ...
              <div className="bg-gradient-to-r from-[#1c2c66] to-[#2a3b7a] p-8 text-white">
                ...
                >
                  Struktur dan Tanggung Jawab Bapas Kelas I Surakarta
                </motion.p>
              </div>
              ...
              <div className="p-8">
                ...
                >
                  ...
                  <motion.div 
                    ...
                    className="bg-[#f8cb8b]/20 border-l-4 border-[#1c2c66] p-6 mb-8"
                    whileHover={{ x: 3 }}
                  >
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                          ...
                          <div className="border border-gray-200 border-t-0 rounded-b-lg p-3">
                            <ul className="text-xs text-gray-600 space-y-1">
                              {['Urusan Kepegawaian', 'Urusan Keuangan', 'Urusan Umum & BMN'].map((item, index) => (
                                <motion.li 
                                  key={index}
                                  whileHover={{ x: 3 }}
                                >
                        ...
                        >
                          ...
                          <div className="border border-gray-200 border-t-0 rounded-b-lg p-3">
                            <ul className="text-xs text-gray-600 space-y-1">
                              {['Bimbingan Narapidana', 'Bimbingan Klien Anak', 'Bimbingan Klien Dewasa'].map((item, index) => (
                                <motion.li 
                                  key={index}
                                  whileHover={{ x: 3 }}
                                >
                        ...
                        >
                          ...
                          <div className="border border-gray-200 border-t-0 rounded-b-lg p-3">
                            <ul className="text-xs text-gray-600 space-y-1">
                              {['Penelitian Kemasyarakatan', 'Pengamatan Klien', 'Assesmen dan Evaluasi'].map((item, index) => (
                                <motion.li 
                                  key={index}
                                  whileHover={{ x: 3 }}
                                >
