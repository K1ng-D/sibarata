      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <FiChevronRight className="mx-2" size={12} />
            <span className="text-white">Sejarah Bapas Surakarta</span>
          </motion.nav>
        </div>
      </motion.header>
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#1c2c66]/90 to-[#2a3b7a]/90 flex items-center justify-center">
                  ...
                  >
                    <h2 className="text-3xl font-bold text-white mb-2">
                      Sejarah Bapas Surakarta
                    </h2>
                    <p className="text-gray-300">
                      Perjalanan panjang sistem pemasyarakatan di Indonesia
                    </p>
                  </motion.div>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                >
                  ...
                  >
                    Bapas merupakan Unit Pelaksana Teknis (UPT) di bidang
                    Pemasyarakatan luar lembaga yang merupakan pranata atau
                    satuan kerja dalam lingkungan Kementerian Hukum dan HAM
                    Republik Indonesia yang bertugas melakukan pembimbingan
                    terhadap klien sampai seorang klien dapat memikul
                    beban/masalah dan dapat membuat pola sendiri dalam
                    menanggulangi beban permasalahan hidup. Pembimbingan yang
                    dimaksud dilakukan di luar Lapas ataupun Rutan.
                  </motion.p>
                  ...
                  <motion.p
                    ...
                    className="text-gray-700 mb-6 leading-relaxed"
                  >
                    Bapas dahulu dikenal dengan istilah Balai Bispa yang
                    kepanjangannya adalah Balai Bimbingan Kemasyarakatan dan
                    Pengentasan Anak. Balai Bispa didirikan berdasarkan
                    Keputusan Menteri Kehakiman RI Nomor : M.02-PR.07.03 tahun
                    1987 tentang Organisasi dan Tata Kerja Balai Bimbingan
                    Kemasyarakatan dan Pengentasan Anak yang bertugas melakukan
                    pembinaan luar lembaga pemasyarakatan yang berada dibawah
                  ...
                  <motion.p
                    ...
                    className="text-gray-700 mb-6 leading-relaxed"
                  >
                    Namun sesuai perkembangan kondisi, tugas dan fungsi
                    berdasarkan Undang-Undang Nomor: 22 tahun 2022 tentang
                    Pemasyarakatan, istilah Bispa diganti menjadi Bapas.
                  </motion.p>
                  ...
                  <motion.p
                    ...
                    className="text-gray-700 mb-6 leading-relaxed"
                  >
                    Bapas Kelas I Surakarta (Bapas Surakarta) adalah satu dari
                    94 UPT Bapas yang ada di Indonesia. UPT ini berada di bawah
                    Kantor Wilayah Kementerian Hukum dan Hak Asasi Manusia Jawa
                    Tengah dan berkedudukan di JL. RM.Said No. 259 Manahan,
                  ...
                  <motion.p
                    ...
                    className="text-gray-700 mb-6 leading-relaxed"
                  >
                    Bapas Surakarta adalah pranata untuk melaksanakan bimbingan
                    dan Pendampingan terhadap Klien Pemasyarakatan di Kementrian
                    Hukum dan Hak Asasi Manusia yang berada di Wilayah kerja
                    Kantor Wilayah Kementerian Hukum dan HAM Jawa Tengah.
                    Wilayah kerja Bapas Surakarta meliputi: Surakarta, Boyolali,
                  ...
                  >
                    ...
                    >
                      {[
                        ...
                        "Berubah nama menjadi Bapas berdasarkan UU No. 22 Tahun 2022",
                        "Merupakan satu dari 94 UPT Bapas di Indonesia",
                        "Wilayah kerja: Surakarta, Boyolali, Karanganyar, dan Sragen",
                      ].map((item, index) => (
                        <motion.li key={index} variants={itemVariants}>
                          {item}
                        </motion.li>
